...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="inline-flex h-12 w-12 items-center justify-center rounded-full text-ink-3 transition-colors hover:bg-paper-3 hover:text-ink focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
    >
      {theme === "dark" ? (
